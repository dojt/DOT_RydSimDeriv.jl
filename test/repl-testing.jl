...
let
    ...
    (  ; 𝛺_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤, 𝛺_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤,  𝛥_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤, 𝛥_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤 ) = hw

    𝑡ᵒⁿ    = (0//1)μs
    𝛿𝑡ᵉᶠᶠ  = δround( (9//10)⋅𝛿𝑡ᵉᶠᶠₘᵢₙ𝛺 + (1//10)⋅𝛿𝑡ᵉᶠᶠₘₐₓ𝛺  ; 𝛿=𝑡ᵣₑₛ )
    Δ_𝑡ᵒᶠᶠ = 𝛿𝑡ᵉᶠᶠ
    𝛥      = 𝛥ₘₐₓ
    𝑇      = max( 𝑡ᵒⁿ + 𝛿𝑡ᵉᶠᶠ + 𝛺ₘₐₓ⋅(1/𝛺_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤 + 1/𝛺_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤)/2 ,
                  Δ_𝑡ᵒᶠᶠ + 𝛥/𝛥_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤                                )
...
let
    global hw
    (; 𝑡ᵣₑₛ,𝛥𝑡ₘᵢₙ,𝑡ᵒᶠᶠₘₐₓ, 𝛿𝑡ᵉᶠᶠₘᵢₙ𝛥,𝛿𝑡ᵉᶠᶠₘₐₓ𝛥,  𝛺ₘₐₓ,𝛺ᵣₑₛ, 𝛥ₘₐₓ,𝛥ᵣₑₛ) = get_hw_data(hw)
    (  ; 𝛺_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤, 𝛺_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤,  𝛥_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤, 𝛥_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤 ) = hw

    𝑡ᵒⁿ    = (0//1)μs
    𝛿𝑡ᵉᶠᶠ  = δround( (7//10)⋅𝛿𝑡ᵉᶠᶠₘᵢₙ𝛥 + (3//10)⋅𝛿𝑡ᵉᶠᶠₘₐₓ𝛥  ; 𝛿=𝑡ᵣₑₛ )
    Ω_𝑡ᵒᶠᶠ = 𝛿𝑡ᵉᶠᶠ
    𝛺      = (0//1)/μs
    𝑇      = max( 𝑡ᵒⁿ + 𝛿𝑡ᵉᶠᶠ + 𝛥ₘₐₓ⋅(1/𝛥_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤 + 1/𝛥_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤)/2 ,
                  Ω_𝑡ᵒᶠᶠ + 𝛺/𝛺_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤                                )
...
let
    ...
    𝑡ᵒⁿ    = (0//1)μs
    𝛿𝑡ᵉᶠᶠ  = δround( (1//10)⋅𝛿𝑡ᵉᶠᶠₘᵢₙ𝛺 + (9//10)⋅𝛿𝑡ᵉᶠᶠₘₐₓ𝛺  ; 𝛿=𝑡ᵣₑₛ )
    Δ_𝑡ᵒᶠᶠ = 𝛿𝑡ᵉᶠᶠ
    𝛥      = 𝛥ₘₐₓ
    𝑇      = max( 𝑡ᵒⁿ + 𝛿𝑡ᵉᶠᶠ + 𝛺ₘₐₓ⋅(1/𝛺_𝑚𝑎𝑥_𝑢𝑝𝑠𝑙𝑒𝑤 + 1/𝛺_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤)/2 ,
                  Δ_𝑡ᵒᶠᶠ + 𝛥/𝛥_𝑚𝑎𝑥_𝑑𝑜𝑤𝑛𝑠𝑙𝑒𝑤                                )
...
#    Set_of_𝛺s = (  -𝛺ₘₐₓ: 𝛺ᵣₑₛ :+𝛺ₘₐₓ  )
    Set_of_𝛺s = (  -δround(15.088/μs;𝛿=𝛺ᵣₑₛ) : 𝛺ᵣₑₛ : δround(15.008/μs;𝛿=𝛺ᵣₑₛ)  )
    N = length(Set_of_𝛺s)
    f⃗ = [  𝑓(𝛺)   for 𝛺 ∈ Set_of_𝛺s  ]
